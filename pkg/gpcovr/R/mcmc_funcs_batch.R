...
#'
#' This and \code{\link{estbeta}} probably should not be two separate functions
...
#'
#' @return Returns a list of information to pass to \code{\link{estbeta}}. Also writes output to some csv files.
#' @export
#'
...
#'
#' This and \code{\link{estbeta_initialize}} probably should not be two separate functions
#' but oh well. This function contains the main MCMC loop.
#'
#' @param filename Name of the file to store the betas in
#' @param errname Name of the file to store the covariance functions in
