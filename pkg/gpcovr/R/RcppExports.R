...
d <- function(k, X, knots) {
    .Call(`_gpcovr_d`, k, X, knots)
}

H <- function(i, X, knots) {
    .Call(`_gpcovr_H`, i, X, knots)
}
...
predict_natspl <- function(basis, coefs) {
    .Call(`_gpcovr_predict_natspl`, basis, coefs)
}
...
dlogspline_unnorm <- function(basis, coefs, knots) {
    .Call(`_gpcovr_dlogspline_unnorm`, basis, coefs, knots)
}
...
normalize_dlogspline <- function(basis, coefs, knots) {
    .Call(`_gpcovr_normalize_dlogspline`, basis, coefs, knots)
}
...
dlogspline <- function(x, coefs, knots) {
    .Call(`_gpcovr_dlogspline`, x, coefs, knots)
}
...
dloglogspline <- function(x, coefs, knots) {
    .Call(`_gpcovr_dloglogspline`, x, coefs, knots)
}

get_slopes <- function(coefs, knots) {
    .Call(`_gpcovr_get_slopes`, coefs, knots)
}
...
get_slope_pts <- function(coefs, knots) {
    .Call(`_gpcovr_get_slope_pts`, coefs, knots)
}
...
plogspline <- function(x, coefs, knots) {
    .Call(`_gpcovr_plogspline`, x, coefs, knots)
}
...
qlogspline <- function(p, coefs, knots, grid_size = 1e-2) {
    .Call(`_gpcovr_qlogspline`, p, coefs, knots, grid_size)
}

rlogspline <- function(n, coefs, knots, grid_size = 1e-2) {
    .Call(`_gpcovr_rlogspline`, n, coefs, knots, grid_size)
}
...
fitsplinecpp <- function(B, y, spl, burnin, initBeta, initSigma, initTau, initBetaTune, initSigmaTune, initTauTune, s_a, s_b, t_a, t_b, c0, c1, k, r, oar, progress) {
    .Call(`_gpcovr_fitsplinecpp`, B, y, spl, burnin, initBeta, initSigma, initTau, initBetaTune, initSigmaTune, initTauTune, s_a, s_b, t_a, t_b, c0, c1, k, r, oar, progress)
}
