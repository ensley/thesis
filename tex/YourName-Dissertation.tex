...
\documentclass[draft,ms,12pt]{psuthesis}
...
%%%%%%%%%%%%%%%%
% Title
\title{Bayesian Semiparametric Covariance Function Estimation for Stationary Gaussian Processes by Overwhelming Force}
...
% Schreyer Honors College. The argument of this command shouldb
...
% Generates the List of Algorithms
\listofalgorithms
