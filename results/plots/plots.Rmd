...
knitr::opts_chunk$set(echo = FALSE, cache = TRUE, fig.height = 7, fig.width = 12)
library(tidyverse)
library(ggthemes)
...
### Runtime of exact covariance calculation vs MC approximation

```{r}
timings <- read_csv('~/git/thesis/results/timings_mc.csv', 
                    col_names = TRUE, 
                    col_types = cols(
  tic = col_double(),
  toc = col_double(),
